...
public class RSACoder {
     ...
     * @return 失败时，返回false。
     */
    public static boolean verifySignature(String src, byte[] sign, byte[] publicKey){
        boolean verfy = false;
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 签名
        String sign = RSACoder.sign(str, privateKey);
        System.out.println("签名：" + sign);

        boolean b = RSACoder.verifySignature(str, sign.getBytes(), publicKey);
